YellowSwitchBlockClass = EntityClass.extend({
    zIndex : 50,
    myPhysBody: null,

    init: function (inputx, inputy, settings) {
        this.currSpriteName = 'switch_yellow_off.png';
        this.pos.x = 200;
        this.pos.y = 300;
        this.hpos.x = 235;
        this.hpos.y = 323;
    ...
    onTouch: function(otherBody, point, impulse){
        ...
        if(data.id == 'lock_yellow' && this.myPhysBody.GetUserData().activated){
...
gGameEngine.factory['switch_yellow_off'] = YellowSwitchBlockClass;